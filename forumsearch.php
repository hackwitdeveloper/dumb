...
?>
							...
							<div class="sidebar-widget recent-post pt-20">
								<h3> <span style="background: -webkit-linear-gradient(45deg, rgba(255,54,75,1) 0%, rgba(175,16,144,1) 43%, rgba(88,13,190,1) 100%);-webkit-background-clip: text; -webkit-text-fill-color: transparent;" >Search Result</span> </h3>
                                <?php
include('connect.php');

$select_query = "select * from forum order by id desc";
...
$run = mysqli_query($connect,$select_query);
                ...
                if (strripos($tags, $keyword) !== false) {
                $c=$c+1;
...
if(isset($_POST['traderforum']))
{
        ...
        $insert_query = "INSERT INTO `forum`(`forumtype`, `qid`, `question`, `date_time`, `user`, `email`, `ans`) VALUES('$forumtype','$qid','$question','$date','$name','$email','0')";
        ...
        if(mysqli_query($connect,$insert_query)){
            ...
            echo "<script>window.open('forum.php?forum=$forumtype','_self')</script>";
            }
