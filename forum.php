				...
				<div class="col-lg-12">
					<div class="breatcome-content text-center">
						...
						<div class="breatcome-content-text">
							<ul>
								<li><a href="index.html">Home </a> <i class="fas fa-chevron-right"></i> <span>Forum</span></li>
							</ul>
						</div>
					</div>
				</div>
...
?>
							<div class="widget-sidebar ml-15">
                                <h4><?php echo $forumname; ?></h4>
                            <div class="card" style="background:#ffc0cb00; border: 1px solid #6c6cc8;" >
                                <div class="card-body" >
                                <form class="src-form" action="forumsearch.php" method="post">
                                    <div class="row" >
                                        <div class="col-lg-9" >
                                            <input type="text" name="keyword" class="form-control" placeholder="Search..."  required>
                                            <input type="hidden" name="forumname" value="<?php echo $forumname; ?>">
                                            <input type="hidden" name="forumid" value="<?php echo $forumid; ?>">
                                        </div>
                                        <div class="col-lg-3" >
									
                                            <button class="btn" type="submit" name="searchbtn" >
                                                Search
                                            </button>
                                        </div>
                                    </div>
							...
							<div class="sidebar-widget recent-post pt-20">
								<h3> <span style="background: -webkit-linear-gradient(45deg, rgba(255,54,75,1) 0%, rgba(175,16,144,1) 43%, rgba(88,13,190,1) 100%);-webkit-background-clip: text; -webkit-text-fill-color: transparent;" >Recent Discussions</span> </h3>
                                <?php
include('connect.php');

$select_query = "select * from forum where forumtype = '$forumname' order by id desc";
...
?>								
								<article class="item">
									...
									<div class="info">
                                        ...
                                        <a href="viewanswers.php?qid=<?php echo $row['qid']; ?>"> Q : <?php echo $row['question']; ?></a>
</h4>
										
                                                
										
                                        <p style="font-weight: normal; font-size: 15px;" > <b>Ansers:</b> <?php echo $answer; ?> </p>
                                        <i class="fa fa-user"  > <?php echo $row['user']; ?></i> | <a href="viewanswers.php?qid=<?php echo $row['qid']; ?>">View All Replies</a> |  <a href="viewanswers.php?qid=<?php echo $row['qid']; ?>#ansersection"> <span style="color:#bf4165;"> Start Answer</span> </a> <br>
										<span class="date">
...
if($temp==0){
?>
<h6>No More Discusion to show! Please start a new topic!</h6>
		<?php } ?>						
							</div>
                                ...
                                <div class="card" style="background:#ffc0cb00; border: 1px solid #6c6cc8;" >
                                <div id="questionsection"  class="card-body" >
                                    ...
                                    <input type="hidden" name="forumid" value="<?php echo $forumid; ?>">
											...
											<div class="col-lg-12">
												<div class="form-group">
													...
													<textarea name="question" class="form-control" id="message" rows="3" placeholder="Write your thoughts here..."></textarea>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group mb-0">
													<button type="submit" name="traderforum" class="btn">Start a Discussion</button>
												</div>
											</div>
										</div>
									</form>
...
if(isset($_POST['traderforum']))
{
        ...
        $insert_query = "INSERT INTO `forum`(`forumid`, `forumtype`, `qid`, `question`, `date_time`, `user`, `email`, `ans`) VALUES('$forumid','$forumtype','$qid','$question','$date','$name','$email','0')";
        ...
        if(mysqli_query($connect,$insert_query)){
            ...
            echo "<script>window.alert('Your Questions Updated successfully!')</script>";
            echo "<script>window.open('forum.php?forum=$forumtype&forumid=$forumid','_self')</script>";
            }
...
?>
					...
					<div class="col-lg-4">
						...
						<div class="widget-sidebar ml-15">
                            <div class="pt-20" >
                                <a href="#questionsection"> <button class="btn ">Start A New Topic</button></a>
...
$select_query = "select * from forum order by ans desc";
...
?>	
									<li style="overflow: hidden;" >
										<a href="viewanswers.php?qid=<?php echo $row['qid']; ?>">
											<?php echo $row['question']; ?> (<?php echo $row['ans']; ?> Ans)
										</a>
									</li>
							<?php } ?>		
								</ul>
