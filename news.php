...
<body>
	...
	<!--==================================================-->
<!-- start blog section -->
<div class="blog-section pt-95 pb-70">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="row pt-30">
				...
				<div class="single-blog-box">
					...
					<div class="blog-content">
						<div class="blog-title">
							<a href="News1.php"><h2>Is Blockchain the Shot in the Arm Healthcare Needs?</h2></a>
						</div>
						...
						<div class="blog-btn">
							<a href="News1.php">Read More <i class="fas fa-plus"></i></a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					...
					<div class="blog-content">
						<div class="blog-title">
							<a href="News2.php"><h2>Tokenized movement will be worth trillions — Sweat Economy co-founder</h2></a>
						</div>
						<div class="blog-content-text">
							<p>Oleg Fomenko of Sweat Economy and Sweatcoin predicts that tokenized physical   </p>
						</div>
						<div class="blog-btn">
							<a href="News2.php">Read More <i class="fas fa-plus"></i></a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					...
					<div class="blog-content">
						<div class="blog-title">
							<a href="News3.php"><h2>Metaverse for healthcare market expected to reach almost $500B by 2033</h2></a>
						</div>
						<div class="blog-content-text">
							<p>Telemedicine and new surgical methods and training paradigms are driving growth.</p>
						</div>
						<div class="blog-btn">
							<a href="News3.php">Read More <i class="fas fa-plus"></i></a>
						</div>
					</div>
				</div>
                </div>
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					...
					<div class="blog-content">
						<div class="blog-title">
							<a href="News4.php"><h2>How blockchain, AI can help research into extending human life</h2></a>
						</div>
						<div class="blog-content-text">
							<p>Jasmine Smith, CEO of Web3-based wellness app Rejuve.AI, told Cointelegraph that decentralized and AI-powered platforms  </p>
						</div>
						<div class="blog-btn">
							<a href="News4.php">Read More <i class="fas fa-plus"></i></a>
						</div>
					</div>
				</div>
                </div>
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					<div class="blog-thumb">
						<img src="assets/images/blog/blog11.jpg" alt="">
						<div class="blog-meta">
							<div class="meta-content">
								<h4>12</h4>
								<span>Feb 2024</span>
					...
					<div class="blog-content">
						<div class="blog-title">
							<a href="News5.php"><h2>9 promising blockchain use cases in healthcare industry</h2></a>
						</div>
						<div class="blog-content-text">
						...
						<div class="blog-btn">
							<a href="News5.php">Read More <i class="fas fa-plus"></i></a>
						</div>
					</div>
				</div>
                </div>
			<!-- <div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					...
					<div class="blog-content">
						<div class="blog-title">
							<a href="viewblog.php"><h2>The Future of Healthcare Tokens</h2></a>
						</div>
						<div class="blog-content-text">
							<p>In today's rapidly evolving digital landscape, blockchain technology has emerged as a powerful tool with the potential to revolutionize various industries</p>
						</div>
						<div class="blog-btn">
							<a href="viewblog.php">Read More <i class="fas fa-plus"></i></a>
						</div>
					</div>
				</div>
			</div>
