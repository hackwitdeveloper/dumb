...
?>
								<h2 style="overflow-wrap: anywhere;" ><?php echo $row['question']; ?></h2>
                                <h6><i class="fa fa-user"  > <?php echo $row['user']; ?></i> | <?php echo $row['date_time']; ?></h6>
...
?>
									...
									<div class="info">
                                        ...
                                        <p style="font-weight: normal; font-size: 15px; overflow-wrap: anywhere;" > <b>Answers:</b> <?php echo $row['answer']; ?> </p>
                                        <a><i class="fa fa-user"  > <?php echo $row['user']; ?></i></a>  <br>
										<span class="date">
                                ...
                                <div  id="ansersection" class="card-body" >

								<div class="leave-form">
									<h3>Start Answer for above question!</h3>
									...
									<form action="addanswer.php" method="post" >
										<div class="row">
											...
											<div class="col-lg-12">
												<div class="form-group">
													<label>Answer</label>
													<textarea name="answer" class="form-control" id="message" rows="3" placeholder="Write your thoughts here..."></textarea>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="form-group mb-0">
													<button type="submit" name="answerbtn" class="btn">Submit Answer</button>
												</div>
											</div>
										</div>
									</form>
...
if(isset($_POST['traderforum']))
{
        ...
        $insert_query = "INSERT INTO `forum`(`forumtype`, `topic`, `qid`, `question`, `date_time`, `user`, `email`, `ans`) VALUES('$forumtype','$topic','$qid','$question','$date','$name','$email','0')";
...
?>
					...
					<div class="col-lg-4">
						...
						<div class="widget-sidebar ml-15">
                            <div class="pt-20" >
                                <a href="#ansersection">
                                <button class="btn ">Start Answer</button>
                                </a>
                            </div>
