				...
				<div class="col-lg-12">
					<div class="breatcome-content text-center">
						...
						<div class="breatcome-content-text">
							<ul>
								<li><a href="index.php">Home </a> <i class="fas fa-chevron-right"></i> <span>Contact</span></li>
							</ul>
						</div>
					</div>
				</div>
					...
					<form action="contact.php" method="POST" >
						<div class="row">
							...
							<div class="quote_btn text_center mt-2">
								<button class="btn" name="enquiry" type="submit"> Send Now </button>
							</div>
						</div>
					</form>
                    <?php
...
if(isset($_POST['enquiry']))
{
    echo "Test";
        ...
        $insert_query = "INSERT INTO `enquiry`(`name`, `phone`, `email`, `message`, `date`, `note`) VALUES ('$name','$phone','$email','$message','$date','$note')";
					...
					<div class="single-conpany-info-box ">
						<div class="single-info-box d-flex">
							...
							<div class="info-content">
                                ...
                                Kodas 306756840 <br>
                                Head Office <br>
                                J. Jasinskio g. 16B, Vilnius, LT-03163 <br>
                                Vilnius, Lithuania</p>
							</div>
						</div>
						<!-- <div class="single-info-box d-flex">
							<div class="info-icon two">
						...
						<div class="info-socail-address pt-20">
