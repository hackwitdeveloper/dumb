			...
			<div class="col-lg-12">
				<div class="dreamit-section-title pb-30">
					...
					<div class="dreamit-section-main-title">
						<h1>Dive Deeper with Our Whitepaper</span> </h1>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="single-blog-box">
					...
					<div class="blog-content">
                        ...
                        <a href="viewwhitepapers.php?id=<?php echo $row['id']; ?>"><h5 style="color:#1919ae;" > <small> <b><?php echo $row['title']; ?></b> </small> </h5></a>
						</div>
						<div class="blog-content-text">
                       
						</div>
						<div class="blog-btn">
                        <a href="viewwhitepapers.php?id=<?php echo $row['id']; ?>">Read More <i class="fas fa-plus"></i></a>
						</div>
					</div>
				</div>
			</div>
