...
$select_query = "select * from whitepaper where id = '$id'";
				...
				<div class="col-lg-14 col-md-12">
					<div class="single-blog-details-box">
						...
						<div class="details-thumb">
							<a href="#"><img src="app/photos/<?php echo $row['image']; ?>" alt=""></a>
						</div>
						<div class="blog-details-content">
							<div class="blog-details-meta">
								<a href="#"><i class="far fa-calendar-alt"></i> <span><?php echo $row['date_time']; ?></span></a> 
								<span><i class="fas fa-user"></i> <a href="#"><?php echo $row['author']; ?></a></span>
							</div>
