				...
				<div class="col-lg-12">
					<div class="breatcome-content text-center">
						...
						<div class="breatcome-content-text">
							<ul>
								<li><a href="index.php">Home </a> <i class="fas fa-chevron-right"></i> <span>FAQ</span></li>
							</ul>
						</div>
					</div>
				</div>
...
<!-- about section -->
<div class="faq-section style-three pt-100 pb-100">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="dreamit-section-title-two text-center pb-20">
					<div class="dreamit-section-main-title">
						<h1><span>Have any</span> <span>Question?</span></h1>
					</div>
