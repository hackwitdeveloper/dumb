				...
				<div class="col-lg-12">
					<div class="breatcome-content text-center">
						<div class="breatcome-content-title">
							<h1> Enquiry form for Private Presale</h1>
						</div>
						<div class="breatcome-content-text">
							<ul>
								<li><a href="index.php">Home </a> <i class="fas fa-chevron-right"></i> <span> Private Presale Registration</span></li>
							</ul>
						</div>
					</div>
				</div>
...
<!-- contact section -->
<div class="contact-section style-two pt-100 pb-100">
	<div class="container">
				...
				<div class="contact_from upper10">
					<div class="dreamit-section-title">
						<div class="dreamit-section-sub-title">
							<h5>Private Presale Regsitration</h5>
						</div>
					</div>
					<form action="presale.php" method="POST" >
						<div class="row">
                            ...
                            <div class="col-lg-6">
								<div class="form_box mb-2">
									<input  class="form-control" id="phone" type="tel" name="phonenumber" placeholder="Phone Number" required> 
								</div>
							</div>
                            <div class="col-lg-6">
								<div class="form_box mb-2">
									<input class="form-control" type="text" name="country_residence" placeholder="Country of Residence *" required > 
								</div>
							</div>
                            <div class="col-lg-6">
								<div class="form_box mb-2">
							...
							<div class="col-lg-6">
								<div class="form_box mb-2">
									<input  class="form-control" type="number" name="intended_contribution_amount" placeholder="Contribution Amount *" required>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="form_box mb-2">
									<input  class="form-control" type="text" name="contribution_preference" placeholder="Contribution Preference *" required >
								</div>
							</div>
                            <div class="col-lg-6">
								<div class="form_box mb-2">
    ...
    <div class="form-check">
        <input class="form-check-input" type="checkbox"  name="man_checkboxman" required>
        <label class="form-check-label" for="countryCheck">
            I confirm that I don’t belong to a Country where Cryptocurrencies / IEO are banned. And I take full responsibility for this Contribution.
        </label>
    </div>
</div>
<div class="col-lg-12">
    <div class="form-check">
        <input class="form-check-input" type="checkbox"  name="mann_checkbox" required>
        <label class="form-check-label" for="responseConsent">
            I consent to Receive Response & I agree to Terms & Conditions & Privacy Policy.
        </label>
    </div>
</div>
<div class="col-lg-12">
    <p>For More Details, Please read our <a href="private-faqscreen.php" style="color: #962c88;">FAQs</a></p>
</div>
							<div class="quote_btn text_center mt-2">
								<button class="btn" name="presale" type="submit"> Register Now </button>
							</div>
						</div>
					</form>
                    <?php
...
if(isset($_POST['presale']))
{
    echo "Test";
        ...
        $man_checkboxman = $_POST['man_checkboxman'];
        $mann_checkbox = $_POST['mann_checkbox'];
        ...
        $insert_query = "INSERT INTO `presale`(`fullname`, `email`, `phonenumber`, `country_residence`, `nationality`, `intended_contribution_amount`, `contribution_preference`, `wallet_address`, `man_checkboxman`, `mann_checkbox`, `date`, `note`) 
VALUES ('$fullname','$email','$phonenumber','$country_residence','$nationality','$intended_contribution_amount','$contribution_preference','$wallet_address','$man_checkboxman','$mann_checkbox','$date','$note')";


        if(mysqli_query($connect,$insert_query)){
            
            include('presalemail.php');
            echo "<script>window.alert('Thank you for submitting Presale Enquiry.We will contact you shortly!')</script>";
...
?>
            ...
            <div class="slider-thumb wow fadeInUp" data-wow-delay=".6s">
						...
						<div class="hero-shape2 bounce-animate4">
							<img src="assets/images/hero/hero3.png" alt="">
						</div>
