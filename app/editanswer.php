...
if(isset($_GET['qid'])) {
    ...
    $query = "SELECT * FROM form_answer WHERE qid = '$qid'";
...
?>
                                        ...
                                        <form action="updateanswer.php" method="POST">
                                            <div class="row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Answer</label>
                                                <div class="col-sm-9">
                                                <textarea name="answer" id="answer" rows="6" cols="35" required="" ><?php echo $row['answer']; ?></textarea>
