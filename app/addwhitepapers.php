                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Add New Whitepaper</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                    <form method="post" action="addwhitepapers.php" enctype="multipart/form-data">
                                            <div class="row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Title</label>
                                                <div class="col-sm-9">
                                                  <input type="text" class="form-control" id="horizontal-firstname-input" placeholder=" Title " name="title" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Whitepaper Content</label>
                                                <div class="col-sm-9">
                                                   <textarea name="content" id="content" rows="6" cols="35" required="" ></textarea>
</div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="horizontal-password-input" class="col-sm-3 col-form-label">Image</label>
                                                <div class="col-sm-9">
                                                  <input type="file" class="form-control" id="horizontal-password-input"  accept=".jpg,.png,.pdf" placeholder="Whitepaper Image" name="image"  required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-sm-9">
                                                    <div>
                                                        <button type="submit" name="addwhitepapers" class="btn btn-primary w-md">Submit</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
...
if(isset($_POST['addwhitepapers']))
{
    echo "Test";
        ...
        $insert_query = "INSERT INTO `whitepaper`(`title`, `author`, `content`, `image`, `date_time`, `note`) VALUES  ('$title','$author','$content','$image','$date_time','$note')";

        if(mysqli_query($connect,$insert_query)){

            echo "<script>window.alert('Thank you for submitting!')</script>";
            echo "<script>window.open('whitepapers.php','_self')</script>";
