                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Update Whitepaper</h4>
...
if(isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM whitepaper WHERE id = '$id'";
...
?>
                                        ...
                                        <form action="updatewhitepapers.php" method="POST" enctype="multipart/form-data">
                                            <div class="row mb-4">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                <textarea  name="content" rows = "6" cols="35"><?php echo $row['content']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
