...
?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                             ...
                                                             <a href="editcustomer.php?id=<?php echo $row['id']; ?>" ><button type="button" class="btn btn-secondary waves-effect waves-light ">
                                                            <i class="mdi mdi-pencil"></i> 
                                                            </button></a>
                                                            <a href="deletecustomer.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');" title="Delete"> <button type="button" class="btn btn-danger waves-effect waves-light ">
