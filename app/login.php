                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-primary p-4">
                                            ...
                                            <p class="text-dark">Sign in to continue to HUMB.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                <div class="auth-logo">
                                    <a href="" class="auth-logo-light">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="assets/images/one.png" alt="" class="rounded-circle" height="70">
                                            </span>
                                        </div>
                                    </a>
                                    ...
                                    <a href="" class="auth-logo-dark">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="assets/images/one.png" alt="" class="rounded-circle" height="24">
                                            </span>
                                        </div>
                                    </a>
                                </div>
...
if (isset($_POST['login'])) {
  ...
  $admin_query = "select * from admin where phone='$phone' AND password='$password'";
...
?>
                        ...
                        <div class="mt-5 text-center">
                            ...
                            <div>
                                ...
                                <p>© <script>document.write(new Date().getFullYear())</script> HUMB. Crafted with <i class="mdi mdi-heart text-danger"></i><a href ="https://seenit.co" target="_blank">by SeenIT PTY LTD</a> </p>
                            </div>
                        </div>
