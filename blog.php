			...
			<div class="col-lg-4 col-md-6">
				<div class="single-blog-box">
					<div class="blog-thumb">
						<img src="app/photos/<?php echo $row['image']; ?>" alt="">
						<div class="blog-meta">
					...
					<div class="blog-content">
						<div class="blog-title">
							<a href="viewblog.php?id=<?php echo $row['id']; ?>"><h2><?php echo $row['blog_title']; ?></h2></a>
						</div>
						<div class="blog-content-text">
							<p><?php echo $small ?>...</p>
						</div>
						<div class="blog-btn">
							<a href="viewblog.php?id=<?php echo $row['id']; ?>">Read More <i class="fas fa-plus"></i></a>
						</div>
					</div>
				</div>
			</div>
