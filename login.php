...
<head>
	...
	<title>HUMB - Beta Testing Program</title>
	<meta charset="utf-8">
...
<!-- contact section -->
<br><br><br>
<div class="contact-section style-two pt-100 pb-100 d-flex align-items-center">
	<div class="container">
						...
						<div class="row">
							...
							<div class="col-lg-12">
								<div class="form_box pt-1">
									<textarea  class="form-control" name="message" id="message" cols="10" rows="5" placeholder="Message" required></textarea>
								</div>
							</div>
							<div class="quote_btn text_center mt-2">
								<button class="btn" name="tester" type="submit"> I want to be a Beta Tester </button>
							</div>
						</div>
					</form>
                    <?php
...
if(isset($_POST['tester']))
{
    echo "Test";
        ...
        $insert_query = "INSERT INTO `tester`(`name`, `country`, `email`, `message`, `date`, `note`) VALUES ('$name','$country','$email','$message','$date','$note')";
...
?>
            ...
            <div class="contact_from upper10">
                ...
                <p style="color:Black">Register to be a Beta Tester. You will receive an email with instruction when Beta Testing commence in your region.</p>
                <div class="dreamit-section-title">
						<div class="dreamit-section-sub-title">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                    <img class="d-block w-100" src="assets/images/banner/3.png" alt="Third slide">
                    </div>
                    <div class="carousel-item">
                    <img class="d-block w-100" src="assets/images/banner/4.png" alt="Third slide">
                    </div>
                    <div class="carousel-item">
                    <img class="d-block w-100" src="assets/images/banner/5.png" alt="Third slide">
                    </div>
                </div>
