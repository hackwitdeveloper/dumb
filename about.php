				...
				<div class="col-lg-12">
					<div class="breatcome-content text-center">
						...
						<div class="breatcome-content-text">
							<ul>
								<li><a href="index.php">Home </a> <i class="fas fa-chevron-right"></i> <span>About Us</span></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-6 col-md-6">
				<div class="about-right-side">
					<div class="dreamit-section-title  pb-20">
						<div >
							<h5>HUMB - Focusing on TOP CRYPTO Assets along with HEALTHCARE Digital Assets</h5>
						</div>
						<div class="dreamit-section-main-title">
							<h1>HUMB an outcome of focused INNOVATION.</h1>
						</div>
						<div class="dreamit-section-content-text">
						    	<h5>The Story behind HUMB</h5>
						</div>
							<p align="justify" >HUMB was founded by a team of experienced professionals from the healthcare and technology industries. Our founders recognized the need for a secure and efficient platform for the exchange of healthcare tokens, cryptocurrencies and healthcare information. They combined their expertise to create HumB, a platform dedicated to revolutionizing the way healthcare transactions are conducted. At HumB, we are committed to providing our clients with the highest level of security and transparency possible.</p>
							
							<h5>Experienced Leadership</h5>
							<p align="justify"> At HUMB, we are led by a team of experienced professionals from the healthcare and technology industries. Our leadership team is committed to achieving our vision of revolutionizing the way healthcare transactions are conducted. With their guidance and expertise, we are confident in our ability to provide our clients with a secure and efficient platform for the exchange of cryptocurrencies, healthcare tokens and healthcare information.</p>
						</div>
					</div>
				</div>
				<!-- <div class="row">
				...
				<div class="about-btn mt-20">
					<a href="register.php">Register Now - Get a Bonus</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-12">
				<div class="dreamit-section-title two text-center pb-20">
					<div class="dreamit-section-sub-title">
						<h5> <img src="assets/images/new/title-img.png" alt="">Vision & Mission</h5>
					</div>
					<div class="dreamit-section-main-title">
			...
			<div class="col-lg-6 col-md-6">
				<div class="single-service-box d-flex">
					...
					<div class="service-content">
						...
						<p>Building a bridge between Healthcare Crypto-World and the Healthcare Real-World. Build Healthcare Crypto Eco-Systems. <br>HUMB Native Token = Healthcare Bitcoin.</p>
					</div>
				</div>
			</div>
			<div class="col-lg-6 col-md-6">
				<div class="single-service-box d-flex">
					...
					<div class="service-content">
						...
						<p>Provide the WORLD’S FIRST Unique Healthcare Focused Exchange, Blockchain and AI Tools where Healthcare with Crypto can express their Use-Cases and Value.
	...
	<div class="container">
		...
		<div class="row pt-30">
			<div class="col-lg-4 col-md-12">
				...
				<div class="single-token-content d-flex align-items-center">
					<!--<div class="single-token-btn">-->
					<!--	<a href="#">BUY NOW</a>-->
					<!--</div>-->
					<div class="token-counte">
						<!--<div class="token-counter-content">-->
						<!--	<h1> <span class="counter">25</span>% <span class="count">Bonus</span></h1>-->
						<!--	<p>Start at 01 Jan, 2023</p>-->
						<!--</div>-->
					</div>
				</div>
			</div>
		...
		<!--<div class="row pt-60">-->
		<!--	<div class="token_list owl-carousel">-->
		<!--		<div class="col-lg-12">-->
