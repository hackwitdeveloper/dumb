					...
					<div class="single-blog-details-box">
						...
						<div class="blog-details-content">
							<div class="blog-details-meta">
								...
								<span><i class="fas fa-user"></i> <a href="https://www.coindesk.com/policy/2019/12/19/is-blockchain-the-shot-in-the-arm-healthcare-needs/" target="_blank" >Source : Coindesk </a></span>
							</div>
							...
							<div class="blog-details-title">
								<a href="#"><h2>Is Blockchain the Shot in the Arm Healthcare Needs?</h2></a>
							</div>
							<div class="blog-details-content-text-inner">
								<p>Alex Cahana asks whether blockchain can make the medicine go down, in looking for solutions to today's healthcare industry.</p>
                                <p>This post is part of CoinDesk's 2019 Year in Review, a collection of 100 op-eds, interviews and takes on the state of blockchain and the world. Dr. Alex Cahana is head of healthcare and blockchain consulting at Genesis Block</p>
                                <p>At the end of 2018, while awakening from the Crypto Winter, a group of noted healthcare professionals led by Mayo Clinic’s John Halamka predicted that 2019 would be a pivotal year for blockchain in the healthcare industry. They said blockchain would become an essential part of consent management, improve remittances and enhance the monetization of personal data. It would tokenize non-cash assets, like patient outcomes, as an incentive to improve health. </p>
                                
                                
                                <p>How much of this agenda was actually realized? The answer is some, but not all. We have seen blockchain deployments in supply chains and for physician credentialing, but not yet implemented as an architecture of electronic health records intended to transform them into self-sovereign, patient-driven digital assets. </p>
                                <p>Why is that, or more fundamentally, why use blockchain in healthcare at all?</p>
                                <p>Healthcare is problematic all over the world. From a patient point of view, healthcare is not always readily accessible and in many cases too expensive. From a healthcare professional’s perspective, there is too much paperwork. For hospital executives, unchecked job growth rate has not translated into better patient outcomes. The future of pharma and digital therapies is fraught with uncertainty. And even insurance brokers have experienced reduced or eliminated commissions on the sale of individual health plans. </p>
                                <p>At least, we can all agree that the healthcare ecosystem is a multi-stakeholder, mal-aligned, friction-full, opaque, heavily-regulated, lacking-of-trust, data-rich environment. From there, we can agree on the need for new responses and approaches, including the use of blockchain. It turns out that blockchain-based platforms are ideal for dealing with the characteristics that plague healthcare.</p>
                                <p>Robert Miller, of ConsenSys Health, produced an excellent report this summer summarizing major trends in the blockchain health space. These include the formation of major new business networks around healthcare use-cases, greater VC funding, and as already mentioned, the use of blockchain for credentialing. </p>
                                <p>This year, half a dozen consortias (like IBM’s Health Utility Network [HUN], Coalesce Health Alliance and MELLODY) announced projects to exchange healthcare and life science data on  using permissioned distributed ledgers. That’s a big deal. Together, these consortia touch the lives of  millions of customers (HUN covers 80 million beneficiaries) in a multi-billion dollar market (MELLODY includes pharma companies with a collective value of more than $300 billion).</p>
                                <p>Venture capital flows have actually slowed, reaching $25M in VC funding this year ($16M of them for Chronicled). This amount is still lower than the $100M-plus raised in 2018 and represents a ridiculously miniscule fraction of the $6B VC funding for non-blockchain digital health projects. As for STOs, the nearly $1B raise in 124 deals included only seven healthcare projects (like Healthbank, Healthereum, Verseon and Agenus), with no significant reported raises.</p>
                                <p>Supply chain applications and physician credentialing are the most common use-cases in healthcare blockchain. The Drug Supply Chain Security Act (DSCSA) of 2013, which mandated the creation of an electronic, interoperable system that can trace and identify distributed prescription drugs, catalyzed the development of a few large scale blockchain-based platforms (like IDLogiq, MediLedger, Rymedi and TraceLink). </p>
                                <p>As for physician credentialing, we’ve seen a multitude of DLT credentialing solutions emerge (like ProCredX developed by HashedHealth, Blockcerts used by the Federation of State Medical Boards, IntivaHealth that maintains records for continuing education and Truu, used by the UK National Health System). But currently these solutions (except Truu) are exclusively business-to-business and do not address the problem of physician identity or improve professional mobility. </p>
                                <p>So what can we expect in 2020? </p>
                                <p>As Nikhil Krishnan correctly predicted in his CB Insight report, the growing blockchain and healthcare landscape (48% CAGR till 2027) is currently dominated by closed consortia, where patient data is minimally used, under strict HIPPA or GDPR regulation. The idea that personal health information in the hands of patients are part of an immutable, master health record has been implemented in Estonia. But it looks like US adoption will be impeded due to a lack of political, regulatory and social appetite to change healthcare from a centralized, corporate, for-profit system into a self-sovereign, decentralized, doctor-patient-driven one.</p>
                                <p>Whether 2020 will be an incremental or transformational year depends on three factors in my opinion.</p>
