...
<head>
	...
	<title>HUMB - Early Registration</title>
	<meta charset="utf-8">
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="form_box mb-2">
                                    <label for="">Name <span style="color:pink" >*</span></label>
									<input class="form-control" type="text" name="name" placeholder="Name *" required>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form_box mb-2">
                                    <label for="">Email <span style="color:pink" >*</span></label>
									<input  class="form-control" type="email" name="email" placeholder="Email *" required>
								</div>
							</div>
							<div class="col-lg-12">
								<div class="form_box mb-1">
                                    <label for="">Phone <span style="color:pink" >*</span></label>
							...
							<div class="col-lg-12">
                                <div class="row" >
                                    <div class="form_box pt-1" style="padding-left:15px;">
                                        <input type="checkbox" name="trader" id="">
                                        <label for="">Trader </label>
                                    </div>
                                    <div class="form_box pt-1" style="padding-left:5px;">
                                        <input type="checkbox" name="token" id="">
                                        <label for="">Token Creator</label>
                                    </div>
                                    <div class="form_box pt-1" style="padding-left:5px;">
                                        <input type="checkbox" name="investor" id="">
                            ...
                            <div class="col-lg-12">
                                <div class="row" >
                                    <div class="form_box pt-1" style="padding-left:15px;">
                                        ...
                                        <label for="">Healthcare Orgs </label>
                                    </div>
                                    <div class="form_box pt-1" style="padding-left:5px;">
							...
							<div class="quote_btn text_center mt-2">
								<button class="btn" name="register" type="submit"> Submit
</button>
							</div>
						</div>
					</form>
...
if(isset($_POST['register']))
{
        ...
        $interest = "";
        if($token == "on"){
            $interest = "Token Creators, ";
        }
        if($trader == "on"){
            $interest = $interest."Traders, ";
        }
        if($investor == "on"){
            $interest = $interest."Investors, ";
        }
        if($health == "on"){
            $interest = $interest."Healthcare Org, ";
        }
        if($other == "on"){
        ...
        $insert_query = "INSERT INTO `customer`(`name`, `phone`, `email`, `interest`, `date`, `note`) VALUES ('$name','$phone','$email','$interest','$date','$note')";

        if(mysqli_query($connect,$insert_query)){

            include('thanksmail.php');

            echo "<script>window.alert('Thank you for registering on HUMB. We will get back to you soon.')</script>";
